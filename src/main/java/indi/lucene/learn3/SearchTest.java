...
public class SearchTest {
    ...
    public void setUp() throws Exception {
        String pathString = "H:\\lucene\\index";
        dir=FSDirectory.open(Paths.get(pathString));
    ...
    public void testTermRangeQuery()throws Exception{
        String searchField="contents";
        String q="1000----1500";
        String lowerTermString = "1000";
        String upperTermString = "1500";
        /**
         * field  字段
         * lowerterm -范围的下端的文字
         *upperterm -范围的上限内的文本
